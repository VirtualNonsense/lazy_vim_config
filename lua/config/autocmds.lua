...
-- e.g. vim.api.nvim_del_augroup_by_name("lazyvim_wrap_spell")        local group = vim.api.nvim_create_augroup("CodeCompanionFidgetHooks", { clear = true })
--#region codecompanion status spinner
local spinner = {
  "🌑", -- new moon
  "🌒", -- waxing crescent
  "🌓", -- first quarter
...
vim.api.nvim_create_autocmd({ "User" }, {
  ...
  callback = function(request)
    ...
    vim.notify(msg, "info", {
      ...
      keep = function()
        return not vim
          .iter({ "Finished", "Opened", "Hidden", "Closed", "Cleared", "Created", "ContextChanged", "ChatDone" })
